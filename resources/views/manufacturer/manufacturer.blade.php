    ...
    <table class="table table-hover">
        ...
        <tbody>
            @foreach ($manufacturer as $i)
                ...
                <div class="modal fade" id="confirmDeleteModal-{{ $i->id_manufacturer }}" tabindex="-1"
                    aria-labelledby="confirmDeleteModalLabel-{{ $i->id_manufacturer }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="confirmDeleteModalLabel-{{ $i->id_manufacturer }}">Confirm
                                    Deletion
                                </h5>
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('manufacturer.delete', $i->id_manufacturer) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container shadow pt-2 mt-2">
                        <form action="/manufacturer/store" method="POST" enctype="multipart/form-data" id="customerForm"
                            ...
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">MANUFACTURER NAME</label>

...
<style>
    * {
    ...
    .header, .general-info, .preparation, .product-formula, .package, .labeling, .hMethode {
        margin: 5px;
    }
        ...
        <table>
            <tbody>
                <tr style="height: 12px">
                    ...
                    <td style="width: 16%;"><p style="font-size: 11sp">Kode Dokumen</p></td>
                    <td style="width: 16%;"><p style="font-size: 10sp">: FRM - PRD - 00</p></td>
                </tr>
                <tr style="height: 12px">
                    <td><p style="font-size: 11sp">Level Dokumen</p></td>
                    <td><p style="font-size: 10sp">: IV</p></td>
                </tr>
                <tr style="height: 12px">
                    <td rowspan="3" style="text-align: center;"><b style="font-size: 18sp">PRODUCTION CONTROL</b></td>
                    <td><p style="font-size: 11sp">Revisi</p></td>
                    <td><p style="font-size: 10sp">: 1</p></td>
                </tr>
                <tr style="height: 12px">
                    <td><p style="font-size: 11sp">Tanggal Efektif</p></td>
                    <td><p style="font-size: 10sp">: 2 Desember 2023</p></td>
                </tr>
                <tr style="height: 12px">
                    <td><p style="font-size: 11sp">Kadaluarsa</p></td>
                    <td><p style="font-size: 10sp">: 4 Desember 2023</p></td>
                </tr>
            </tbody>
        </table>
    </div>

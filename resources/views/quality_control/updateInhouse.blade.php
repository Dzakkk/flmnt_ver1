    ...
    <div class="container shadow pt-2 mt-2 pb-2">
        <form action="/qc/update/{{ $qc->no_production }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="no_production" class="form-control" id="1"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="test_methode" class="form-control" id="8" value="{{ $qc->test_methode }}">
                </div>
            </div>
            <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="range" name="color_value" class="form-range range-slider" min="0"
                                max="5" id="color_range" value="{{ $qc->color_value }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="range" name="odour_value" class="form-range range-slider" min="0"
                                max="5" id="odour_range" value="{{ $qc->odour_value }}">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="range" name="taste_value" class="form-range range-slider" min="0"
                                max="5" id="taste_range" value="{{ $qc->taste_value }}">
                ...
                <div class="col-md-10">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex">
                            <div class="col-md-2 me-1">
                                <label for="">min</label>
                                <input type="text" name="sg_d20_min" id="sg_d20_min" class="form-control-plaintext"
                                    value="{{ $prd->sg_d20_min }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">max</label>
                                <input type="text" name="sg_d20_max" id="sg_d20_max" class="form-control-plaintext"
                                    value="{{ $prd->sg_d20_max }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">target</label>
                                <input type="text" name="sg_d20_target" id="" class="form-control-plaintext"
                                    value="{{ $prd->sg_d20_target }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">value</label>
                                <input type="number" name="sg_d20_value" id="value1" class="form-control" value="{{ $qc->sg_d20_value }}">
                            </div>
                            <div class="col-md-3 me-1">
                                <label for="">Result</label>
                                <input type="text" name="sg_d20_result" id="result1" class="form-control" value="{{ $qc->sg_d20_result }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="d-flex">
                            <div class="col-md-2 me-1">
                                <label for="">min</label>
                                <input type="text" name="sg_d25_min" id="sg_d25_min" class="form-control-plaintext"
                                    value="{{ $prd->sg_d25_min }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">max</label>
                                <input type="text" name="sg_d25_max" id="sg_d25_max" class="form-control-plaintext"
                                    value="{{ $prd->sg_d25_max }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">target</label>
                                <input type="text" name="sg_d25_target" id="sg_d25_target" class="form-control-plaintext"
                                    value="{{ $prd->sg_d25_target }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">value</label>
                                <input type="number" name="sg_d25_value" id="value2" class="form-control" value="{{ $qc->sg_d25_value }}">
                            </div>
                            <div class="col-md-3 me-1">
                                <label for="">Result</label>
                                <input type="text" name="sg_d25_result" id="result2" class="form-control" value="{{ $qc->sg_d25_result }}">
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex">
                            <div class="col-md-2 me-1">
                                <label for="">min</label>
                                <input type="text" name="ri_d20_min" id="ri_d20_min" class="form-control-plaintext"
                                    value="{{ $prd->ri_d20_min }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">max</label>
                                <input type="text" name="ri_d20_max" id="ri_d20_max" class="form-control-plaintext"
                                    value="{{ $prd->ri_d20_max }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">target</label>
                                <input type="text" name="ri_d20_target" id="ri_d20_target" class="form-control-plaintext"
                                    value="{{ $prd->ri_d20_target }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">value</label>
                                <input type="number" name="ri_d20_value" id="value3" class="form-control" value="{{ $qc->ri_d20_value }}">
                            </div>
                            <div class="col-md-3 me-1">
                                <label for="">Result</label>
                                <input type="text" name="ri_d20_result" id="result3" class="form-control" value="{{ $qc->ri_d20_result }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="d-flex">
                            <div class="col-md-2 me-1">
                                <label for="">min</label>
                                <input type="text" name="ri_d25_min" id="ri_d25_min" class="form-control-plaintext"
                                    value="{{ $prd->ri_d25_min }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">max</label>
                                <input type="text" name="ri_d25_max" id="ri_d25_max" class="form-control-plaintext"
                                    value="{{ $prd->ri_d25_max }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">target</label>
                                <input type="text" name="ri_d25_target" id="ri_d25_target" class="form-control-plaintext"
                                    value="{{ $prd->ri_d25_target }}">
                            </div>
                            <div class="col-md-2 me-1">
                                <label for="">value</label>
                                <input type="number" name="ri_d25_value" id="value4" class="form-control" value="{{ $qc->ri_d25_value }}">
                            </div>
                            <div class="col-md-3 me-1">
                                <label for="">Result</label>
                                <input type="text" name="ri_d25_result" id="result4" class="form-control" value="{{ $qc->ri_d25_result }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                   <select name="status" id="3" class="form-control">
                    <option value="{{ $qc->status }}">{{ $qc->status }}</option>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="note" class="form-control" id="4" value="{{ $qc->note }}">
                </div>
            </div>

...
<div>
    <div class="container shadow pt-2 mt-2 pb-2">
        <form action="/qc/update/{{ $nl->NoSuratJalanMasuk_NoProduksi }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 row">
                <label for="1" class="col-sm-2 col-form-label">No Production</label>
                <div class="col-sm-10">
                    <input type="text" name="no_production" class="form-control" id="1"
                        value="{{ $nl->NoSuratJalanMasuk_NoProduksi }}">
                </div>
            </div>
            <div class="mb-3 row">
